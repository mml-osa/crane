                                            ...
                                            <div class="col-md-12 ">
                                                ...
                                                <div class="portlet light bordered">
                                                    ...
                                                    <div class="portlet-body form">
                                                        <form method="POST" action="{{ route('admin.posts.categories.store') }}" role="form">
                                                            @csrf
                                                            <div class="form-body">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                                        <input id="description" type="text" class="form-control" name="description" autocomplete="off" required />
                    ...
                    <div class="table-container">
                        <table class="table table-striped table-bordered table-hover table_content" id="sample_2">
                            ...
                            @foreach($postCategories as $postCategory)
                                <tr>
                                    <td> {{$counter}} </td>
                                    <td><a href="{{ route('admin.posts',array('post_category'=>encrypt($postCategory->id))) }}">{{$postCategory->title}}</a> </td>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 ">
                                                        ...
                                                        <div class="portlet light bordered">
                                                            ...
                                                            <div class="portlet-body form">
                                                                <form role="form" action="{{ route('admin.posts.categories.update',$postCategory->id) }}" method="POST" style="display: none;">
                                                                    @csrf
                                                                    <div class="form-body">
                                                                        <div class="col-md-12">
                                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                                <input name="title" type="text" class="form-control" id="title" value="{{$postCategory->title}}" autofocus autocomplete="off" required />
                                                                                <label for="title">Category Title</label>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form id="delete-user" action="{{ route('admin.posts.categories.destroy',$postCategory->id) }}" method="POST" style="display: none;">
                                                    @csrf
