...
<script src="{{asset('public/admin/assets/global/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js')}}" type="text/javascript"></script>
<script src="{{asset('public/admin/assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js')}}" type="text/javascript"></script>
<script src="{{asset('public/admin/assets/global/plugins/clockface/js/clockface.js')}}" type="text/javascript"></script>
<script src="{{asset('public/admin/assets/pages/scripts/components-date-time-pickers.min.js')}}" type="text/javascript"></script>
...
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="{{asset('web')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
...
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="{{asset('public/admin/assets/global/plugins/dropzone/dropzone.min.js')}}" type="text/javascript"></script>
<script src="{{asset('public/admin/assets/pages/scripts/form-dropzone.min.js')}}" type="text/javascript"></script>
...
<script src="{{asset('public/admin/assets/global/plugins/jquery.sparkline.min.js')}}" type="text/javascript"></script>
<script src="{{asset('public/admin/assets/pages/scripts/profile.min.js')}}" type="text/javascript"></script>
<script src="{{asset('public/admin/assets/global/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js')}}" type="text/javascript"></script>

<!-- BEGIN PAGE LEVEL PLUGINS -->
{{--<script src="{{asset('public/admin/assets/pages/scripts/ui-nestable.min.js')}}" type="text/javascript"></script>--}}
<script src="{{asset('public/admin/assets/global/plugins/jquery-nestable/jquery.nestable.js')}}" type="text/javascript"></script>
<script src="{{asset('public/admin/assets/global/scripts/app.min.js')}}" type="text/javascript"></script>
<script src="{{asset('public/admin/assets/pages/scripts/portfolio-1.min.js')}}" type="text/javascript"></script>
