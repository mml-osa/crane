    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="{{route('dashboard')}}">
                @if($logo != null)<img src="{{asset("storage/app/public/web/logo/$logo->img")}}" alt="logo"
                                       class="logo-default" width="150"/>@endif
            </a>
            ...
            <ul class="nav navbar-nav pull-right">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                <li>
                                    <a href="#">
                                        <span class="photo"><img src="../assets/layouts/layout3/img/avatar2.jpg"
                                ...
                                <li>
                                    <a href="#">
                                        <span class="photo"><img src="../assets/layouts/layout3/img/avatar3.jpg"
                                                                 class="img-circle" alt=""> </span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="photo"><img src="../assets/layouts/layout3/img/avatar1.jpg"
                                                                 class="img-circle" alt=""> </span>
                                        <span class="subject">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        @if(!empty($session->userProfile['avatar']))
                            <?php $img = $session->userProfile['avatar'];?>
                            <img src="{{asset("storage/app/public/user/avatar/$img")}}" class="img-circle" alt="">
                        @else<img alt="" class="img-circle" src="{{asset("public/user/assets/images/default/user-img.png")}}"/>@endif
                        <span class="username username-hide-on-mobile"> Hello, {{ $session->userProfile['first_name'] ?? null }} </span>
                        <i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li><a href="{{route('users.profile',$session->id)}}"><i class="icon-user"></i> My Profile </a></li>
                        <li class="divider"></li>
