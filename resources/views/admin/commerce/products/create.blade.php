...
@section('content')
  ...
  <!-- BEGIN PAGE TITLE-->
  <h1 class="page-title">Products | <small>add new product</small></h1>
  <!-- END PAGE TITLE-->
  ...
  <div class="row">
          ...
          <div class="portlet-body form">
            ...
            <div class="col-md-12 text-right">
              <div class="form-actions noborder">
                ...
                {{--                                <a href="{{route('products.index')}}" class="btn btn-sm default">Close</a>--}}
              </div>
            </div>
            ...
            <div class="form-body">
              ...
              <div class="col-md-6">
                <div class="form-group form-md-line-input form-md-floating-label">
                  <input name="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}"
                         value="{{ old('title') }}" id="title" autofocus autocomplete="title" required/>
              ...
              <div class="col-md-6">
                <div class="form-group form-md-line-input form-md-floating-label">
                  <input name="caption" type="text"
                         ...
                         value="{{ old('caption') }}" id="caption" autocomplete="caption"/>
              ...
              <div class="col-md-2">
                <div class="form-group form-md-line-input form-md-floating-label">
                  <input name="price" type="text"
                         ...
                         value="{{ old('price') }}" id="price" autocomplete="price"/>
              ...
              <div class="col-md-2">
                <div class="form-group form-md-line-input form-md-floating-label">
                  <input name="discount" type="number"
                         ...
                         value="{{ old('discount') }}" id="discount" autocomplete="discount"/>
              ...
              <div class="col-md-2">
                <div class="form-group form-md-line-input form-md-floating-label">
                  <input name="quantity" type="text"
                         ...
                         value="{{ old('quantity') }}" id="quantity" autocomplete="quantity"/>
              ...
              <div class="col-md-3">
                <div class="form-group form-md-line-input form-md-floating-label">
                  <input name="promo_start" type="date"
                         ...
                         value="{{ old('promo_start') }}" id="promo_start" autocomplete="promo_start"/>
              ...
              <div class="col-md-3">
                <div class="form-group form-md-line-input form-md-floating-label">
                  <input name="promo_end" type="date"
                         ...
                         value="{{ old('promo_end') }}" id="promo_end" autocomplete="promo_end"/>
              ...
              <div class="col-md-12">
                {{--                                @trix(\App\Models\Product::class, 'content')--}}
                {{--                                <input type="submit">--}}
            ...
            {{--                                    <input type="checkbox" name="published" id="published" value="1"> Publish Product--}}
            {{--                                    <span></span>--}}
            {{--                                </label>--}}
            {{--                            </div>--}}
            {{--                        </div>--}}
        ...
        <div class="portlet light bordered">
          <div class="portlet-title tabbable-line">
            <div class="caption">
              ...
              <span class="caption-subject font-dark bold">Product Properties</span>
            </div>
          </div>
          <div class="portlet-body">
            <div class="tab-content">
              <div class="tab-pane active" id="portlet_tab2_1">
                <p><b>Published: </b><input type="radio" name="published" id="published_1" value="1"> <label
                    for="published_1"> Yes</label> &emsp;<input type="radio" name="published" id="published_0"
                                                                value="0"> <label for="published_0"> No</label></p>

                <p><b>Featured: </b><input type="radio" name="featured" id="featured_1" value="1"> <label
                    for="featured_1"> Yes</label> &emsp;<input type="radio" name="featured" id="featured_0"
                                                               value="0"> <label for="featured_0"> No</label></p>
                <p><b>Visibility: </b><br>
                  @foreach ($visibility as $visible)
                    <input type="radio" name="visibility_id" id="visibility_id{{$visible->id}}"
                           value="{{$visible->id}}">
                ...
                <p><b>Created At: </b><a href="#create_date" data-target="#create_date" data-toggle="modal"
                                         title="Click to change product date">{{ now() }}</a></p>
    ...
    <div class="modal fade" id="newProductCategory" tabindex="-1" role="form" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
