...
@section('content')
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> Video Items |
        <small> video media album items</small>
    </h1>
    <!-- END PAGE TITLE-->
                ...
                <div class="col-md-9">
                    ...
                    <div id="js-grid-juicy-projects" class="cbp">
                        @foreach($items as $item)
                            @if($item->mediaAlbum != null && $item->mediaAlbum->mediaType['alias'] == 'video')
                                ...
                                <div class="cbp-item {{$album_alias}}">
                                    <div class="cbp-caption">
                                        <div class="cbp-caption-defaultWrap">
                                            @if($item->url != null)
                                                <img src="{{asset("public/web/images/icon/video.png")}}" alt="image" width="50">
                                            @endif
                                            <div class="cbp-caption-activeWrap">
                                                <div class="cbp-l-caption-alignCenter">
                                                    <div class="cbp-l-caption-body">
                                                        <a href="{{$item->url}}" class="cbp-lightbox cbp-l-caption-buttonRight btn red uppercase btn red uppercase" data-title="video">view video</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <a data-toggle="modal" href="#img_caption{{$item->id}}" title="video title and caption"><span class="text-primary"><i class="fa fa-file-text"></i></span></a> &bullet;
                                            <a data-toggle="modal" href="#img_change{{$item->id}}" title="change video"><span class="text-success"><i class="fa fa-refresh"></i></span></a> &bullet;
                                            <a data-toggle="modal" href="#img_publish{{$item->id}}" title="@if($item->published == 1)unpublish @else publish video @endif">@if($item->published == 1) <span class="text-danger"><i class="fa fa-close"></i></span> @else <i class="fa fa-check"></i> @endif</a> &bullet;
                                            <a data-toggle="modal" href="#img_remove{{$item->id}}" title="remove video"><span class="text-danger"><i class="fa fa-trash"></i></span></a>
                                        </div>
                                    </div>
                    ...
                    @foreach($items as $item)
                        @if($item->mediaAlbum->mediaType['alias'] == 'video')
                            <?php $album_alias = $item->mediaAlbum['alias']?>
                                                    ...
                                                    <div class="portlet light bordered">
                                                        <div class="portlet-title">
                                                            <div class="caption font-blue">
                                                                ...
                                                                <span class="caption-subject bold uppercase">Video Caption</span>
                                                            </div>
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                        </div>
                                                        <div class="portlet-body form">
                                                            <form method="POST" action="{{ route("media.video.caption.store") }}" role="form">
                                                                @csrf
                                                                <div class="form-body">
                                                ...
                                                <div class="col-md-12 ">
                                                    ...
                                                    <div class="portlet light bordered">
                                                        <div class="portlet-title">
                                                            <div class="caption font-blue">
                                                                <i class="icon-layers font-blue"></i>
                                                                <span class="caption-subject bold uppercase">Video Change</span>
                                                            </div>
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                        </div>
                                                        <div class="portlet-body form">
                                                            <form method="POST" action="{{ route("media.video.edit",$item->id) }}" role="form" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="form-body">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group form-md-line-input form-md-floating-label">
                                                                    ...
                                                                    <p> Click on "Change Video" to pick a new video to replace. Accepted formats are JPG, JPEG, PNG, BMP, GIF, and should not be more than 1mb </p>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                            <h4 class="modal-title">@if($item->published == 0) Publish @else Unpublish @endif This Video </h4>
                                        </div>
                                        <div class="modal-body text-center"> Are you sure you want to @if($item->published == 0) publish @else unpublish @endif this video? </div>
                                        <div class="modal-footer">
                                            <form class="form-horizontal" method="post" action="{{ route('media.video.publish',$item->id) }}">
                                                @csrf
                            ...
                            <div class="modal fade" id="img_remove{{$item->id}}" tabindex="-1" role="form" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form id="delete-item" action="{{ route('media.video.destroy',$item->id) }}" method="POST">
                                                @csrf
