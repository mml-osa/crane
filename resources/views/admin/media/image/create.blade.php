        ...
        <div class="col-md-9 ">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green">
                        ...
                        <span class="caption-subject bold uppercase"> Media Content Link </span>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-md-line-input form-md-floating-label">
                                <form method="post" action="{{route('media.image.store',['type' => 'image','id' => $album->id])}}" enctype="multipart/form-data">
                                    @csrf
                                    <label for="url">Enter Image Link Here...</label>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green">
                        <i class="icon-layers font-green"></i>
                        <span class="caption-subject bold uppercase"> Media Content File </span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{route('media.image.store',['type' => 'image','id' => $album->id])}}" class="dropzone dropzone-file-area" id="my-dropzone" style="width: 500px; margin-top: 50px;" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form id="delete-item" action="{{ route('media.image.remove',['type' => 'image','id' => $album->id]) }}" method="POST">
                                                            @csrf
