...
@section('content')
    ...
    <div class="row">
        ...
        <form method="POST" action="{{ route('pages.store') }}" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" name="name" autofocus required />
                                    <label for="name">Page Name</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" value="{{ old('title') }}" name="title" required />
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <textarea name="description" id="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" value="{{ old('description') }}" rows="3"></textarea>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="portlet_tab2_1">
                                @foreach ($pageCategories as $pageCategory)
                                    <input type="checkbox" name="cat_id" id="cat_id{{$pageCategory->id}}" value="{{$pageCategory->id}}">
            ...
            <div class="col-md-3">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="portlet_tab2_1">
                                <a href="#banner" data-toggle="modal" title="select image">Click here to select image...</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="banner" tabindex="-1" role="form" aria-hidden="true">
