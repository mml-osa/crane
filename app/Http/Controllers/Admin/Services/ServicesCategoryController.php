...
class ServicesCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        } catch (\Exception $e) { return redirect()->back()->with("error", "Services categories page not loading properly"); }
    }
...
//        try {
            ...
            CcServicesCategory::create($request->all());
            return redirect()->back()->with('success', 'Service category has been added successfully');
//        } catch (\Exception $e) { return redirect()->back()->with("warning", "There was a problem adding the service category"); }
    ...
    public function publish(Request $request,$id)
    {
        try {
            ...
            CcServicesCategory::findOrFail($id)->update(['published' => $request->switch]);
            return redirect()->back()->with("success", "Service category status updated successfully");
        } catch (\Exception $e) { return redirect()->back()->with("error", "There was a problem updating service category post");}
    }
